...
module[2] = function(owner, org, mulTime)
	...
	if org.isPly and not org.otrub and org.blood < 2900 then org.owner:Notify(math.random(2) == 1 and "I can't feel anything..." or (math.random(2) == 1 and "I think I'm gonna faint right now...") or "I don't feel so good...",60,"blood2",0) end
